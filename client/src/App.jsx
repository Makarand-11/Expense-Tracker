      ...
      <div className="flex flex-col justify-center items-center mt-[3%] w-[80%] ml-[5%] mr-[5%]">
          ...
          <div className="relative flex justify-between w-[300px]">
            ...
            {showAddExpense &&
              <div className="absolute z-[999] flex flex-col p-[10px] top-[20px] left-0 h-[500px] w-[500px] bg-white shadow-xl">
                ...
                <input type="text" placeholder="Snacks" className="outline-none border-2 border-[#555] border-solid p-[10px]"></input>
                <label htmlFor="" className="mt-[10px] font-semibold text-[18px]">Expense Date</label>
                <input type="date" placeholder="11/02/2025" className="outline-none border-2 border-[#555] border-solid p-[10px]"></input>
                <label htmlFor="" className="mt-[10px] font-semibold text-[18px]">Expense Amount</label>
                <input type="Number" placeholder="50" className="outline-none border-2 border-[#555] border-solid p-[10px]"></input>
        ...
        <div className="flex flex-col">
          <div className="relative flex justify-between items-center w-[80vw] h-[100px] bg-[#f3edeb] my-[20px] py-[10px]">
            ...
            <span className="m-[20px] text-[18px]">11/02/2025</span>
          ...
          <div className="relative flex justify-between items-center w-[80vw] h-[100px] bg-[#f3edeb] my-[20px] py-[10px]">
            ...
            <span className="m-[20px] text-[18px]">07/02/2025</span>
          ...
          <div className="relative flex justify-between items-center w-[80vw] h-[100px] bg-[#f3edeb] my-[20px] py-[10px]">
            ...
            <span className="m-[20px] text-[18px]">06/02/2025</span>
          ...
          <div className="relative flex justify-between items-center w-[80vw] h-[100px] bg-[#f3edeb] my-[20px] py-[10px]">
            <h2 className="m-[20px] text-[#555] text-[18px] font-medium">Gas</h2>
            <span className="m-[20px] text-[18px]">02/02/2025</span>
            <span className="m-[20px] text[18px] font-medium">200$</span>
            <div className="m-[20px]">
              <FaTrash className="text-red-500 mb-[5px] cursor-pointer" />
              <FaEdit className="text-[#555] mb-[5px] cursor-pointer" />
